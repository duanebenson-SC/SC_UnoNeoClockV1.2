...
// SC_UnoNeoClock code
//
// For the Screaming Circuits UnoNeoClock
// by Duane Benson, 2016 - 2018
//
// SC_UnoNeoClock is Arduino UNO compatible. It uses a Maxim DS3231M RTC
...
// Supports SC_UnoNeoClock V1.2
//
// Compiled with Arduino IDE V1.6.10
